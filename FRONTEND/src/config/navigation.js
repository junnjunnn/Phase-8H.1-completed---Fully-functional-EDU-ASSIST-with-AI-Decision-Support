export const navigationItems = [
  ...
  { label: 'Academic Years', path: '/academic-structure', roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN'] },
  { label: 'Grade Levels', path: '/academic-structure', roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN'] },
  { label: 'Sections', path: '/academic-structure', roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN'] },
  { label: 'Subjects', path: '/academic-structure', roles: ['SUPER_ADMIN', 'SCHOOL_ADMIN'] },
